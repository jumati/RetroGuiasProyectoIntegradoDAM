...
public class EditarUsuarioLogueadoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editar_usuario_logueado);
        ...
        email_editText.setText(getIntent().getStringExtra("email"));
        name_editText.setText(getIntent().getStringExtra("name"));
        last_name_editText.setText(getIntent().getStringExtra("last_name"));
        phone_editText.setText(getIntent().getStringExtra("phone"));
            ...
            public void onClick(View view) {
                ...
                query.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@androidx.annotation.NonNull DataSnapshot snapshot) {
                        ...
                        {
                            // Almacenamos los datos en un mapa
                            Map<String, Object> userMap = new HashMap<>();
                            userMap.put("name", name_editText.getText().toString().trim());
                            userMap.put("last_name", last_name_editText.getText().toString().trim());
                            userMap.put("phone", phone_editText.getText().toString().trim());
                            // Se inserta en la base de datos
                            ref.child("Users").child(snap.getKey()).updateChildren(userMap);
                        }
                    }
                    ...
                    public void onCancelled(@androidx.annotation.NonNull DatabaseError error) {
                        ...
                        Toast.makeText(EditarUsuarioLogueadoActivity.this,
    ...
    private void eliminarUsuario()
    {
        eliminar_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(EditarUsuarioLogueadoActivity.this, EliminarUsuarioActivity.class));
            }
        });
    }
    ...
    private void volver()
    {
        volver_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(EditarUsuarioLogueadoActivity.this, GuidesActivity.class));
            }
        });
    }
    ...
    private void passwordCredential()
    {
        ...
        auth.getCurrentUser().reauthenticate(credential)
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(EditarUsuarioLogueadoActivity.this, "Reautenticación exitosa", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(EditarUsuarioLogueadoActivity.this, "Error en la reautenticación", Toast.LENGTH_SHORT).show();
            }
        });
    }
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(EditarUsuarioLogueadoActivity.this,
                                    ...
                                    Toast.LENGTH_LONG).show();Toast.makeText(EditarUsuarioLogueadoActivity.this, "Contraseña cambiada exitosamente", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(EditarUsuarioLogueadoActivity.this,
